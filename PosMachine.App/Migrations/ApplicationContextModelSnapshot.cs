...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PosMachine.Models.MeioPagamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PosMachine.Models.Taxa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PosMachine.Models.TipoVenda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PosMachine.Models.Venda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PosMachine.Models.Vendedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PosMachine.Models.MeioPagamento", b =>
                {
                    b.HasOne("PosMachine.Models.Taxa", "Taxa")
                        .WithMany()
            ...
            modelBuilder.Entity("PosMachine.Models.Venda", b =>
                {
                    b.HasOne("PosMachine.Models.MeioPagamento", "MeioPagamento")
                        .WithMany()
                        .HasForeignKey("MeioPagamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PosMachine.Models.Taxa", "TaxaParcela")
                        .WithMany()
                        .HasForeignKey("TaxaParcelaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PosMachine.Models.TipoVenda", "TipoVenda")
                        .WithMany()
                        .HasForeignKey("TipoVendaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PosMachine.Models.Vendedor", "Vendedor")
                        .WithMany()
